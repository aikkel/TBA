...
c278 = Room("1", "A corridor", "The passageway soon comes to an end at a blocked wooden door. You listen to the door but hear nothing. Will you try to charge the door down?")
r343 = Room("2", "Pit", "The door bursts open and you fall headlong into a room. Bur your heart jumps as you realize you are not landing on the floor, but plunging down a pit!")
...
r82 = Room("5", "NEED NAME", "Asleep is the same sort of creature that you found at the sentry post. You may creep into the room and try to take the box. Do you wanna test your luck?")
...
r397 = Room("7", "NEED NAME", "The door opens.. There is a stale smell in the air. Under the table is a small box. Do you want to open the box?")
...
r370 = Room("9", "NEED NAME", "The door opens. A small box rests under the table. Around the table are two creatures. They are drinking. You assume they are drunk. Do you wanna fight?")
...
c278.add_exit("west", c71)
c278.add_exit("east", r343)

r343.add_exit("west", c71)
