...
#         self.sound_player = SoundPlayer()  # Create a SoundPlayer instance
...
#             self.sound_player.play_lucky()  # Play the lucky sound
#             player.luck -= 1
#             print(f"You got lucky! Your luck is now {player.luck}" )
#             return "lucky! " + str(player.luck)
#         else:
#             self.sound_player.play_unlucky()  # Play the unlucky sound
#             player.luck -= 1
#             return "unlucky!"
...
#     # Stats
#     # skill and luck = 1d6+6, meaning pass 1,6
